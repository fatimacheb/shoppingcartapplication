...
class OrderitemsControllerTest < ActionController::TestCase
  ...
  test "should create orderitem" do
    assert_difference('Orderitem.count') do
      post :create, orderitem: { item_id: @orderitem.item_id, order_id: @orderitem.order_id }
    end
  ...
  test "should update orderitem" do
    patch :update, id: @orderitem, orderitem: { item_id: @orderitem.item_id, order_id: @orderitem.order_id }
    assert_redirected_to orderitem_path(assigns(:orderitem))
  end
